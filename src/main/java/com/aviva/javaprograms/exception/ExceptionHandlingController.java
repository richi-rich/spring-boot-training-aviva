...
public class ExceptionHandlingController {
	 ...
	 * Gets called when input provided is invalid
	 * 
	 * @param inputIsNotInRangeException
	 *            exception of type {@link InputIsNotInRangeException}
	 * @return Exception response composed in {@link ResponseEntity}
	 */
	@ExceptionHandler(InputIsNotInRangeException.class)
	public ResponseEntity<ExceptionResponse> passedInputIsNotInRange(
			InputIsNotInRangeException inputIsNotInRangeException) {
		return getResponseEntity(HttpStatus.BAD_REQUEST, inputIsNotInRangeException.getMessage(),
				"https://www.xyz.com/InputIsNotInRangeException.html", new HttpHeaders());
	}
